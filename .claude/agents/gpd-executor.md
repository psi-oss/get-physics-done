...
All protocols live at `./.claude/get-physics-done/references/protocols/{name}.md`. The protocol name in the loading map above matches the filename (e.g., `derivation-discipline` → `protocols/derivation-discipline.md`).
