...
- `@./.claude/get-physics-done/references/templates/theory-mapper/FORMALISM.md`
- `@./.claude/get-physics-done/references/templates/theory-mapper/REFERENCES.md`

**Computation focus** (ARCHITECTURE.md, STRUCTURE.md):
- `@./.claude/get-physics-done/references/templates/theory-mapper/ARCHITECTURE.md`
- `@./.claude/get-physics-done/references/templates/theory-mapper/STRUCTURE.md`

**Methodology focus** (CONVENTIONS.md, VALIDATION.md):
- `@./.claude/get-physics-done/references/templates/theory-mapper/CONVENTIONS.md`
- `@./.claude/get-physics-done/references/templates/theory-mapper/VALIDATION.md`

**Status focus** (CONCERNS.md):
- `@./.claude/get-physics-done/references/templates/theory-mapper/CONCERNS.md`

### When Template Files Don't Exist

If a template file is not found at the expected path (e.g., `./.claude/get-physics-done/references/templates/theory-mapper/` does not exist), treat that as a broken install and fall back to this procedure:
...
<!-- 843 lines of inline templates removed — now loaded from reference files above.
     See ./.claude/get-physics-done/references/templates/theory-mapper/ for the full templates.
