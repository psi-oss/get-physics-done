...
**Plan template:** Use `./.claude/get-physics-done/templates/phase-prompt.md` for the canonical PLAN.md format (frontmatter fields, task XML structure, must-haves schema, scope guidance, and worked examples).
