...
If no project config exists yet, the workflow offers an early interaction-style choice before long setup steps so `supervised` can affect initialization rather than only later phases.
