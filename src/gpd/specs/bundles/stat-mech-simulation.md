...
This exemplar bundle validates the protocol-bundle framework. The system-level
logic stays generic; this file only supplies metadata and asset references.
