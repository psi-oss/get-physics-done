...
description: Researches physics domain ecosystem before roadmap creation. Produces files in .gpd/research/ consumed during roadmap creation. Spawned by $gpd-new-project or $gpd-new-milestone orchestrators.
type: agent
allowed-tools:
  - read_file
  - write_file
