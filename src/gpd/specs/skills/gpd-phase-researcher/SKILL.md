...
description: Researches how to execute a physics research phase before planning. Produces RESEARCH.md consumed by gpd-planner. Spawned by $gpd-plan-phase orchestrator.
type: agent
allowed-tools:
  - read_file
  - write_file
...
| YELLOW | 35-50% | Prioritize remaining research areas, synthesize after 8-10 searches |
| ORANGE | 50-65% | Synthesize findings now, prepare RESEARCH.md with what you have |
