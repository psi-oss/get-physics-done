...
description: Conducts systematic literature reviews for physics research topics with citation analysis and open question identification. Spawned by $gpd-literature-review orchestrator.
type: agent
allowed-tools:
  - read_file
  - write_file
...
- `$gpd-literature-review` orchestrator
...
| YELLOW | 35-50% | Prioritize remaining review areas, stick to tier-appropriate depth |
| ORANGE | 50-60% | Synthesize findings now, prepare checkpoint summary |
| RED | > 60% | STOP immediately, write checkpoint with review completed so far, return with CHECKPOINT status |
