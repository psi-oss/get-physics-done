...
- `$gpd-discover` — Phase-specific discovery with depth levels (quick/medium/deep). Use when investigating methods and approaches for a specific research phase.
- `$gpd-research-phase` — Spawns a dedicated researcher agent for deep phase-specific investigation. Use when you need exhaustive domain knowledge before planning a phase.
</objective>
