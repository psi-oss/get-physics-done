...
- `$gpd-discover` — Lighter-weight discovery with depth levels (quick/medium/deep). Use for quick feasibility checks or method surveys before committing to full research.
