...
Output: {phase}-VERIFICATION.md tracking all check results. If issues found: diagnosed gaps with severity classification, verified fix plans ready for $gpd-execute-phase
...
<process>
Execute the verify-work workflow from @{GPD_INSTALL_DIR}/workflows/verify-work.md end-to-end.
