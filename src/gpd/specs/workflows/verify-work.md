...
- `autonomy=guided` (default): Pause only if verification reveals critical issues requiring user judgment.
- `autonomy=autonomous`: Run full verification pipeline. Present final VERIFICATION.md at end.
