...
Template for `.planning/DERIVATION-STATE.md` — cumulative record of equations, conventions, and intermediate results across all sessions.
...
5. **Git preserves history.** Pruned content is recoverable via `git log -p -- .planning/DERIVATION-STATE.md`.
```
