...
- **Owner file**: `.planning/PROJECT.md` (status), `.planning/STATE.md` (position)
...
- **Active → Checkpoint**: Plan has `autonomous: false` in frontmatter; executor pauses for user review
