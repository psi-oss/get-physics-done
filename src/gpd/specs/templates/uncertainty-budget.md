...
Template for `.planning/analysis/UNCERTAINTY-BUDGET.md` -- tracks all numerical quantities, their uncertainties, and how uncertainties propagate through multi-step calculations.
