...
**Detailed protocols:** For step-by-step calculation protocols, see `protocols/monte-carlo.md` (Metropolis, cluster algorithms, histogram methods), `protocols/order-of-limits.md` (thermodynamic limit, critical limits), `protocols/finite-temperature-field-theory.md` (Matsubara formalism, thermal field theory), `protocols/numerical-computation.md` (general numerical methods), `protocols/exact-diagonalization.md` (small systems, symmetry sectors), `protocols/stochastic-processes.md` (Langevin dynamics, master equations, FDT), `protocols/renormalization-group.md` (RG flows, critical exponents, universality), `protocols/bethe-ansatz.md` (exact solutions for integrable models), `protocols/large-n-expansion.md` (1/N expansion for critical exponents), `protocols/resummation.md` (Borel summation of asymptotic series), `protocols/kinetic-theory.md` (Boltzmann equation, transport coefficients).
