...
- `verification-core.md` — analytical verification checks (dimensional analysis, limiting cases, conservation laws) that code tests should encode
- `hypothesis-driven-research.md` — predict-derive-verify cycle; code tests are the computational implementation of stated predictions
