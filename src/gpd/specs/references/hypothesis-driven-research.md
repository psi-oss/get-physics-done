...
**See also:** `verification-core.md` — prediction patterns (limiting cases, symmetry constraints, conservation laws) map directly to the verification checks used to validate results.
</why_predict_first>
