...
The verification-quick-reference.md lists 14 numbered checks. The verifier uses 15 checks numbered 5.1-5.15. Mapping:
...
- `verification-quick-reference.md` — Compact 14-check checklist
- `verification-core.md` — Universal checks (dimensional, limiting cases, symmetry, conservation)
