...
> **Note:** For cosmology/GR, see `verification-domain-gr-cosmology.md`. For fluids/plasma, see `verification-domain-fluid-plasma.md`. For astrophysics, see `verification-domain-astrophysics.md`.
