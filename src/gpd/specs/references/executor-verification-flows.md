...
See `references/computational-verification-templates.md` for copy-paste-ready templates covering: dimensional analysis, limiting case evaluation, numerical spot-check, identity verification, and convergence testing.
