...
- `llm-physics-errors.md` — Full 101-error-class catalog with detection strategies
- `verification-hierarchy-mapping.md` — Agent scope boundaries and check mappings
- `verification-core.md` — Universal verification checks
- `shared-protocols.md` — Convention Tracking Protocol and ASSERT_CONVENTION syntax
- `agent-infrastructure.md` — Convention Loading Protocol
