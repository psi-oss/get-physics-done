...
Extracted from `llm-physics-errors.md` for lightweight loading. Maps each error class to the verification checks most likely to catch it.

**Full catalog:** See `llm-physics-errors.md` (index) for detailed descriptions, detection strategies, and examples of all 104 error classes across 4 part files.
...
For a compact summary of HIGH-risk classes, see `verification-gap-summary.md`.
