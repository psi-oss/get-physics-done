...
**Related files:**
- `verification-quick-reference.md` — compact checklist
- `verification-core.md` — dimensional analysis, limiting cases, conservation laws
- `verification-domain-qft.md` — Ward identities and ordinary field-theoretic checks
- `verification-domain-mathematical-physics.md` — self-adjointness, spectral theory, general rigor checks
- `protocols/algebraic-qft.md` — formulation-specific workflow
