...
**Related files:**
- `planning-config.md` — Config schema including `autonomy` and `research_mode` fields
- `model-profiles.md` — Model profile system (deep-theory/numerical/exploratory/review/paper-writing)
- `agent-infrastructure.md` — Agent spawning and orchestration
...
See references/publication-pipeline-modes.md for mode specifications.
```
...
- `planning-config.md` — Full config schema
- `model-profiles.md` — Model profile system (orthogonal to modes)
- `checkpoints.md` — Checkpoint types and frequencies
- `agent-infrastructure.md` — Agent spawning and context allocation
