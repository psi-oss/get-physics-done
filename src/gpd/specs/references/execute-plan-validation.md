...
Referenced by `workflows/execute-plan.md`. Governs physics validation gates, deviation handling, and verification failures during plan execution.
...
**Full rules:** See `executor-deviation-rules.md` for complete 6-rule system with examples and escalation protocols. The compact table below maps to the full rules as noted.
