...
Extracted from `shared-protocols.md` for lightweight loading. The most common source of LLM physics errors is convention mismatch between expressions from different sources.

**Full protocol:** See `shared-protocols.md` for the complete convention tracking protocol, machine-readable assertions, and conflict detection procedures.
