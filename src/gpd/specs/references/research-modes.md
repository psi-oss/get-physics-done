...
- `planning-config.md` — Full config schema documentation
- `model-profiles.md` — Profile definitions (orthogonal to research mode)
...
- `agent-infrastructure.md` — Context pressure management (affected by research mode)
