...
- `verification-domain-statmech.md` — statistical mechanics (partition functions, phase transitions)
- `verification-domain-condmat.md` — condensed matter (order parameters, symmetry breaking)
