...
> **Key companion document:** See `../errors/llm-physics-errors.md` for the catalog of 101 LLM-specific physics error classes with detection strategies and traceability matrix.
