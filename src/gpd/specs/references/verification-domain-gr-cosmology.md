...
- `verification-domain-qft.md` — QFT, particle physics (for quantum gravity overlap)
- `verification-domain-astrophysics.md` — astrophysics (for observational cosmology overlap)
