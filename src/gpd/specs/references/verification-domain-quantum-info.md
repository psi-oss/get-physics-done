...
- `verification-domain-amo.md` — AMO physics (for physical qubit implementations)
- `verification-domain-condmat.md` — condensed matter (for topological qubits, many-body entanglement)
