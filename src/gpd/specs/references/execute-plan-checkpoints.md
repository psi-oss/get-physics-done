...
Referenced by `workflows/execute-plan.md`. Governs checkpoint creation, previous attempt detection, checkpoint handling during execution, and cleanup.
...
The tag is only kept when failures occur (see `execute-plan-recovery.md`).
