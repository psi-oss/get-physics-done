...
> **Note:** For quantum information, see `verification-domain-quantum-info.md`. For AMO, see `verification-domain-amo.md`. For soft matter, see `verification-domain-soft-matter.md`.
