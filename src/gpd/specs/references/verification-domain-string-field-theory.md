...
- `verification-domain-qft.md` — BRST and gauge-theory checks with field-theory language
- `verification-domain-mathematical-physics.md` — homotopy-algebra and structural consistency
- `protocols/string-field-theory.md` — formulation-specific workflow
