...
- `verification-numerical.md` — convergence, statistical validation
- `verification-domain-gr-cosmology.md` — GR/cosmology (for relativistic astrophysics)
- `verification-domain-statmech.md` — statistical mechanics (for equation of state)
