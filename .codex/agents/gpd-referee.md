...
- `@./.codex/get-physics-done/references/physics-subfields.md` -- Subfield context for understanding standards, conventions, and key results in the field
- `@./.codex/get-physics-done/references/verification/core/verification-core.md` -- Physics verification checks to apply during review
