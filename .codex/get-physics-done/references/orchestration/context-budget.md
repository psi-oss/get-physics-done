...
**Subagent advantage:** Each subagent (gpd-executor, gpd-planner, etc.) gets a fresh context window. The orchestrator's context stays lean. This is why `../../workflows/execute-plan.md` routes autonomous work to subagents.
</context_consumption>
