...
## Contextual Help (Default Mode)

When help is invoked without arguments, show state-aware guidance:
...
Output the complete GPD command reference from @./.codex/get-physics-done/workflows/help.md.
