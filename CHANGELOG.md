...
- Initial release -- extracted from PSI monorepo as a standalone package.
...
- 8 MCP tool servers: conventions, verification, protocols, errors, patterns, state, skills, blackboard.
...
- MCTS strategy bridge for PSI pipeline integration.
