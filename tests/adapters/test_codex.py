...
""",
    ...
    def test_install_agents_inline_gpd_agents_dir_in_agent_and_skill_surfaces(
        self,
        adapter: CodexAdapter,
        gpd_root: Path,
        tmp_path: Path,
        ...
        for content in (
            (target / "agents" / "gpd-main.md").read_text(encoding="utf-8"),
            (skills / "gpd-main" / "SKILL.md").read_text(encoding="utf-8"),
        ):
